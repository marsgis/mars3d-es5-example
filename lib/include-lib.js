...
window.configLibs = {
  ...
  "cesium-networkPlug": ["mars3d/thirdParty/networkPlug/CesiumNetworkPlug.js"],
  quickearth: ["geotiff/geotiff.js", "mars3d/thirdParty/quickearth/quickearth.core.js", "mars3d/thirdParty/quickearth/quickearth.cesium.js"],
  "es5-widget": [
    //原生JS项目widget模块插件
  ...
  iserverGeojson: ["geojson/iserver-geojson.js"],
  ...
  layer: ["layer/theme/default/layer.css", "layer/theme/retina/retina.css", "layer/theme/mars/layer.css", "layer/layer.js"],
  "jquery.scrollTo": ["jquery/scrollTo/jquery.scrollTo.min.js"],
  "jquery.minicolors": ["jquery/minicolors/jquery.minicolors.css", "jquery/minicolors/jquery.minicolors.min.js"],
  "jquery.range": ["jquery/range/range.css", "jquery/range/range.js"],
  ztree: ["jquery/ztree/css/zTreeStyle/zTreeStyle.css", "jquery/ztree/css/mars/ztree-mars.css", "jquery/ztree/js/jquery.ztree.all.min.js"],
  jstree: ["jstree/themes/default-dark/style.css", "jstree/jstree.min.js"],
  "jquery.mCustomScrollbar": ["jquery/mCustomScrollbar/jquery.mCustomScrollbar.css", "jquery/mCustomScrollbar/jquery.mCustomScrollbar.js"],
  jedate: ["jquery/jedate/skin/jedate.css", "jquery/jedate/jedate.js"],
  lazyload: ["jquery/lazyload/jquery.lazyload.min.js"],
  bootstrap: ["bootstrap/css/bootstrap.css", "bootstrap/js/bootstrap.bundle.min.js"],
  "bootstrap-table": [
  ...
  "bootstrap-checkbox": ["bootstrap/bootstrap-checkbox/awesome-bootstrap-checkbox.css"],
  "bootstrap-slider": ["bootstrap/bootstrap-slider/bootstrap-slider.min.css", "bootstrap/bootstrap-slider/bootstrap-slider.min.js"],
  nprogress: ["nprogress/nprogress.css", "nprogress/nprogress.min.js"],
  toastr: ["toastr/toastr.css", "toastr/toastr.js"],
  formvalidation: [
  ...
  "admui-frame": ["admui/css/site.css", "admui/js/app.js"],
  "admin-lte": [
  ...
  highlight: ["highlight/styles/foundation.css", "highlight/highlight.pack.js"],

  animate: ["animate/animate.css"],
  "font-awesome": ["fonts/font-awesome/css/font-awesome.min.css"],
  "font-marsgis": ["fonts/marsgis/iconfont.css"],
  "web-icons": ["fonts/web-icons/web-icons.css"],

  ////////////////////////// 其他库////////////////////////
  haoutil: ["hao/haoutil.js"],
